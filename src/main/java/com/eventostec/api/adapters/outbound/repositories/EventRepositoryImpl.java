...
public class EventRepositoryImpl implements EventRepository {
    ...
    public EventRepositoryImpl(JpaEventRepository jpaEventRepository, EventMapper mapper) {
    ...
    public List<Event> findAll() {
        return this.jpaEventRepository.findAll()
                 .stream()
                .map(entity -> new Event(entity.getId(), entity.getTitle(),entity.getDescription(), entity.getImgUrl(), entity.getEventUrl(), entity.getRemote(),entity.getDate())).collect(Collectors.toList());
    }
    ...
    @Override
    public org.springframework.data.domain.Page<EventAddressProjection> findfilteredEvents(String city, String uf, Date startDate, Date endDate, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        return this.jpaEventRepository.findFilteredEvents(city, uf, startDate, endDate, pageable);
    }

    @Override
    public List<EventAddressProjection> findEventsRyTitle(String title) {
